import{_ as n,c as s,a,o as i}from"./app-Dwcq6rbY.js";const l={};function r(t,e){return i(),s("div",null,e[0]||(e[0]=[a(`<p>Three.js 是一个强大的 JavaScript 库，它让我们能够轻松地在网页上创建和渲染复杂的三维场景。无论你是想构建3D游戏、数据可视化，还是交互式艺术作品，Three.js 都能帮助你快速上手。本篇文章将带你了解Three.js 的基础知识，并展示如何创建一个简单的3D场景。</p><h3 id="什么是three-js" tabindex="-1"><a class="header-anchor" href="#什么是three-js"><span>什么是Three.js？</span></a></h3><p>Three.js 是一个基于 WebGL 的开源 JavaScript 库，它为开发者提供了丰富的工具来创建3D对象、相机、光源等，并能在浏览器中高效渲染3D图形。由于WebGL 直接在 GPU 上运行，Three.js 的性能非常好，适合开发具有实时交互的应用。</p><h3 id="搭建开发环境" tabindex="-1"><a class="header-anchor" href="#搭建开发环境"><span>搭建开发环境</span></a></h3><p>要使用Three.js，我们首先需要搭建一个基本的开发环境。可以使用任何你喜欢的开发工具，这里我们使用 Vite 来快速搭建一个项目。</p><ol><li><strong>安装 Vite</strong> 如果你还没有安装 Vite，先安装它：</li></ol><div class="language-javaScript line-numbers-mode" data-highlighter="prismjs" data-ext="javaScript" data-title="javaScript"><pre><code><span class="line">npm create vite@latest threejs-demo --template vanilla</span>
